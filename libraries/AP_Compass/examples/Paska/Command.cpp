...
const struct Command commands[] PROGMEM = {
  ...
  { "stabilizer_pid_zn", c_stabilizer_pid_zn,
    e_float, &paramRecord.s_Ku_fast, &paramRecord.s_Tu_fast },
  { "stabilizer_slow_pid_zn", c_stabilizer_pid_zn,
    e_float, &paramRecord.s_Ku_slow, &paramRecord.s_Tu_slow },
  ...
  { "rxzero", c_rxzero, e_calib, paramRecord.rxZero },
  { "rxmin", c_rxmin, e_calib, paramRecord.rxMin },
  { "rxmax", c_rxmax, e_calib, paramRecord.rxMax },
  { "model", c_model },
  { "zero", c_zero },
  { "alpha", c_alpha },
  { "dump", c_dump },
